...
Se encontrou um bug no Escola Aberta você pode reportá-lo usando a ferramenta de
[issues do GitHub](https://github.com/prefeiturasp/SME-EscolaAberta/issues). Porém antes
...
[criar uma nova issue](https://github.com/prefeiturasp/SME-EscolaAberta/issues/new). 
...
1. Certifique-se de que sua ideia já não esteja sendo abordada dentro do conjuntos de issues [issues do GitHub](https://github.com/prefeiturasp/SME-EscolaAberta/issues);
...
Para criar seu pedido de recurso basta
[criar uma nova issue](https://github.com/prefeiturasp/SME-EscolaAberta/issues/new) usando
o label **recurso**.
/new) usando
o label **recurso**.
...
- Fale sobre o Escola Aberta nas suas redes sociais, blogs, etc. Espalhe a palavra;
